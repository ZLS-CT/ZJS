...
import com.zephy.zjs.api.vec.Vec3f
...
import com.zephy.zjs.api.render.VertexFormat as CTVertexFormat
...
object RenderUtils {
    ...
    fun getRenderPos(x: Float, y: Float, z: Float): Vec3f {
        return Vec3f(
            x - ZPlayer.getRenderX().toFloat(),
            y - ZPlayer.getRenderY().toFloat(),
            z - ZPlayer.getRenderZ().toFloat(),
        )
    }
