...
import com.zephy.zjs.api.triggers.ITriggerType
...
import com.zephy.zjs.internal.launch.IInjector
...
object JSLoader {
    ...
    fun setup(jars: List<URL>) {
        ...
        val sourceProvider = UrlModuleSourceProvider(listOf(ZJS.MODULES_FOLDER.toURI()), listOf())
    ...
    fun entrySetup(): Unit = wrapInContext {
        ...
        val moduleProvidedLibs = saveResource(
            ...
            File(ZJS.MOD_FOLDER, "modules-provided-libs.js"),
        )
    ...
    private fun loadMixinLibs() {
        val mixinProvidedLibs = saveResource(
            ...
            File(ZJS.MOD_FOLDER, "mixin-provided-libs.js"),
        )
