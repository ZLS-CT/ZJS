(function (global) {
    ...
    const JSLoader = Java.type('com.zephy.zjs.internal.engine.JSLoader').INSTANCE;
    ...
    const MixinObj = Java.type('com.zephy.zjs.internal.launch.Mixin');
    const AtObj = Java.type('com.zephy.zjs.internal.launch.At');
    const SliceObj = Java.type('com.zephy.zjs.internal.launch.Slice');
    const LocalObj = Java.type('com.zephy.zjs.internal.launch.Local');
    const ConstantObj = Java.type('com.zephy.zjs.internal.launch.Constant');
    const InjectObj = Java.type('com.zephy.zjs.internal.launch.Inject');
    const RedirectObj = Java.type('com.zephy.zjs.internal.launch.Redirect');
    const ModifyArgObj = Java.type('com.zephy.zjs.internal.launch.ModifyArg');
    const ModifyArgsObj = Java.type('com.zephy.zjs.internal.launch.ModifyArgs');
    const ModifyConstantObj = Java.type('com.zephy.zjs.internal.launch.ModifyConstant');
    const ModifyExpressionValueObj = Java.type('com.zephy.zjs.internal.launch.ModifyExpressionValue');
    const ModifyReceiverObj = Java.type('com.zephy.zjs.internal.launch.ModifyReceiver');
    const ModifyReturnValueObj = Java.type('com.zephy.zjs.internal.launch.ModifyReturnValue');
    const ModifyVariableObj = Java.type('com.zephy.zjs.internal.launch.ModifyVariable');
    const WrapOperationObj = Java.type('com.zephy.zjs.internal.launch.WrapOperation');
    const WrapWithConditionObj = Java.type('com.zephy.zjs.internal.launch.WrapWithCondition');
    ...
    class At {
        ...
        _initProps(obj) {
            ...
            this.atObj = new AtObj(
                value, id, slice, shift, by, args, target, ordinal, opcode,
            )
        }
    }
    ...
    class Mixin {
        ...
        _initProps(obj) {
            ...
            this.mixinObj = new MixinObj(target, priority);
        }
